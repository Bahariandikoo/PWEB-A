...
var kata = document.querySelector("#input-kata")
var cari = document.querySelector("#btn-cari")
var hasil = document.querySelector("#definisi")
function translator(){
    hasil.innerText = library[kata.value]
}
cari.addEventListener("click",translator)

function hapus() {
    document.getElementById("myForm").value = ''
    document.getElementById("definisi").innerHTML = ""
  }
